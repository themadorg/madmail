...
var API_DOCS = {
    ...
    endpoints: [
        ...
        {
            id: "message-size", resource: "/admin/message-size", methods: ["GET", "PUT", "DELETE"],
            title: { en: "Message Size Limit", fa: "سقف اندازه پیام", ru: "Лимит размера сообщения", es: "Tamaño máximo de mensaje" },
            desc: { en: "SMTP/IMAP/WebSMTP max message size (<code>appendlimit</code> and <code>max_message_size</code>). Default <code>100M</code>.", fa: "حداکثر اندازه پیام برای SMTP/IMAP/WebSMTP. پیش‌فرض <code>100M</code>.", ru: "Максимальный размер сообщения для SMTP/IMAP/WebSMTP. По умолчанию <code>100M</code>.", es: "Tamaño máximo de mensaje SMTP/IMAP/WebSMTP. Predeterminado <code>100M</code>." },
            examples: [
                { label: { en: "Current limit", fa: "محدودیت فعلی", ru: "Текущий лимит", es: "Límite actual" }, code: '{\n    "status": 200,\n    "body": {\n        "effective": "100M",\n        "effective_bytes": 104857600,\n        "appendlimit": "100M",\n        "max_message_size": "100M"\n    }\n}' },
                { label: { en: "Set limit", fa: "تنظیم سقف", ru: "Установить лимит", es: "Fijar límite" }, code: '{"method": "PUT", "resource": "/admin/message-size",\n "body": {"size": "100M"}, ...}' },
                { label: { en: "Reset overrides", fa: "بازنشانی", ru: "Сброс переопределений", es: "Restablecer" }, code: '{"method": "DELETE", "resource": "/admin/message-size", ...}' }
            ]
        },
        {
