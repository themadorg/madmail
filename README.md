...
- **Video Call discovery**: Support for IMAP METADATA (RFC 5464) to automatically provision TURN credentials for Delta Chat Video Calls
...
6. **Integrated VoIP Support**: Automatic discovery of video call TURN credentials via IMAP METADATA, with dynamic credential generation for enhanced security.
