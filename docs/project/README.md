...
| 16 | [16-troubleshooting-and-testing.md](./16-troubleshooting-and-testing.md) | Common issues, logs, DB inspection, integration tests, Delta Chat E2E, [relay-ping](https://github.com/themadorg/relay-ping) |
...
- **Hot in-memory state** (`AppState`) + write-through to SQLite or PostgreSQL + Maildir. Postgres how-to: [user-guide/18-postgres.md](./user-guide/18-postgres.md). SQLite copy: `madmail db sqlite-to-postgres`.
