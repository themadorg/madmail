...
| **SQLite + PostgreSQL** | Both backends supported; live config reload without restart. Empty Postgres: [operator guide](./18-postgres.md). Existing SQLite: `madmail db sqlite-to-postgres`. |
